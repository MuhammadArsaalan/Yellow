	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				Projeto Yellow has a powerful layout system which allows you to configure and use a different layout per
				route.
			</Typography>
			...
			>
				...
				page where there isn't any toolbar or navbar showing, without leaving the Projeto Yellow.
			</Typography>
