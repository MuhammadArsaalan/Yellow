...
/**
 * The OverviewPageLayoutsUI component provides an overview of Projeto Yellow's page layouts.
 */
		...
		<>
			...
			<section className="prose prose-sm dark:prose-invert">
				...
				<Typography paragraph>
					Page layouts in Projeto Yellow are pre-designed, customizable templates that serve as the foundation for
				...
				<Typography paragraph>
					Projeto Yellow's page layouts are designed to be intuitive and easy to implement. Simply copy the
