...
/**
 * Updating Projeto Yellow Doc
 * This document provides information on how to update Projeto Yellow.
 */
	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				Projeto Yellow isn’t an end product or an extension so there is no easy way to update the project. Due to
				the nature of apps, we cannot give any set instructions for updating Projeto Yellow. It heavily depends on
				your project and it's up to you to update your code. However, there are a couple points that we want to
				put forward which might help you to keep Projeto Yellow updated:
			</Typography>
			...
			>
				<ol>
					...
					<li className="mb-16">
						...
						changes manually, but it's the best way to keep the Projeto Yellow updated.
					</li>
				</ol>
			</Typography>
		</>
