	...
	return (
		<>
			...
			<Typography
				...
				component="p"
			>
				To change the default language of the Projeto Yellow, you need to change <code>lng</code> setting in the
...
const handleLanguageChange = async (newLanguageId) => {
  await changeLanguage(newLanguageId);
			...
			<Typography
				...
				component="p"
			>
				Projeto Yellow uses a custom I18nProvider to manage language settings and provide language-related
