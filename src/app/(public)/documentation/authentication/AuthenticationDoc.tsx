...
function AuthenticationDoc() {
	return (
		<>
			...
			>
				Authentication in Projeto Yellow with Next.js App Router
			</Typography>
			<Typography
				className="mb-16"
				component="p"
			>
				Projeto Yellow uses Auth.js (formerly NextAuth.js) for authentication management, integrated with Next.js
...
export { handler as GET, handler as POST }
			...
			<Typography
				...
				component="p"
			>
				In Projeto Yellow, we've extended the default Auth.js session handling to include additional user data. When
  ...
  interface Session {
    ...
    db: User;
			...
			<Typography
				...
				component="p"
			>
				Projeto Yellow provides a custom <code>useUser</code> hook that simplifies access to user data and provides
    ...
    <div>
      ...
      {/* Add more user profile information and management here */}
			...
			<Typography
				...
				component="p"
			>
				By leveraging the custom session handling and the <code>useUser</code> hook, Projeto Yellow provides a
			...
			<Typography
				...
				component="p"
			>
				By leveraging Auth.js with Next.js App Router, Projeto Yellow provides a robust, flexible, and secure
